...
<section class="signup_part mt-5 mb-5">
                    ...
                    <div class="signup_part_form_iner">
                        ...
                        <div class="col-md-12 form-group p_star mb-3">
                            ...
                            <div class="col-md-6 form-group p_star mb-3">
                                <input type="email" class="form-control" name="email" placeholder="Email Address" value="<?php echo htmlspecialchars($email_address); ?>" required>
                            </div>
    <div class="col-md-6 form-group p_star mb-3">
    <select class="form-control" id="gender" name="gender" required>
        ...
        <option value="Female" <?php echo ($gender === 'Female') ? 'selected' : ''; ?>>Female</option>
                            ...
                            <div class="col-md-6 form-group p_star mb-3">
                                <input type="text" class="form-control" name="mobile_number" placeholder="Phone Number" value="<?php echo htmlspecialchars($phone_number); ?>" required>
                            </div>
                            <div class="col-md-6 form-group p_star mb-3">
                                <input type="text" class="form-control" name="address" placeholder="Address" value="<?php echo htmlspecialchars($n_office_address); ?>" >
                            </div>
                            <div class="col-md-6 form-group p_star mb-3">
