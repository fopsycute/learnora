...
if (mysqli_affected_rows($con) == 0) {
    ...
    while ($row = mysqli_fetch_array($sql2)) {
        ...
        $profile_picture = !empty($row['profile_photo']) ? $row['profile_photo'] : 'user.png';
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="training.php" class="menu-link">
                    <div data-i18n="training.php">My List</div>
                  </a>
                </li>
                <li class="menu-item">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="<?php echo $siteurl.$imagePath.$profile_picture; ?>" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          <div class="flex-shrink-0 me-3">
                            <div class="avatar avatar-online">
                              <img src="<?php echo $siteurl.$imagePath.$profile_picture; ?>" alt="" style="object-fit:contain;" class="w-px-40 h-auto rounded-circle" />
                            </div>
                          </div>
