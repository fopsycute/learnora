...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit-aff-link'])) {
    ...
    $query = "SELECT * FROM {$siteprefix}users WHERE email_address = '$affemail' AND type='affiliate'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $update_query = "UPDATE {$siteprefix}users SET reset_token = '$token', reset_token_expiry = '$expiry' WHERE email_address = '$affemail'";
