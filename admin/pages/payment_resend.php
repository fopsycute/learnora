...
$query = "SELECT mp.s, mp.order_id, mp.user_id, mp.amount, mp.proof, mp.date_created, u.display_name, u.email_address AS email 
          FROM " . $siteprefix . "manual_payments mp
          JOIN " . $siteprefix . "users u ON mp.user_id = u.s
          WHERE mp.status = 'payment resend'";
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) { ?>
                        <tr>
                            ...
                            <td class="text-nowrap"><?php echo $sitecurrency . formatNumber($row['amount'], 2); ?></td>
