        ...
        <div class="card-body">
            <form method="POST" enctype="multipart/form-data">
                ...
                <div>
                 ...
                 <img  style="width:10%; height:auto;" src="<?php echo $siteurl;?>uploads/<?php echo htmlspecialchars($profile_photo); ?>" class="mt-3" alt="Avatar" id="profilePicturePreview" onclick="document.getElementById('profilePictureInput').click();">
                </div>
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="email" class="form-control" id="email" name="email" value="<?php echo htmlspecialchars($email_address, ENT_QUOTES, 'UTF-8'); ?>" required>
                    </div>
                </div>
                <div class="form-row row">
