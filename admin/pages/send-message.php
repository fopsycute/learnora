                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                     ...
                     while ($row = mysqli_fetch_array($sql2)) {
                      echo '<option value="' . $row['email_address'] . '">' . $row['display_name'] . ' (' . $row['type'] . ')</option>'; }?>
                        </select>
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-message">Message Content</label>
                          <textarea id="basic-default-message" name="content" class="form-control" placeholder="This course is a course for ..." required/></textarea>
                        </div>
