...
if(isset($_POST['order_id'])) {
    ...
    $sql = "SELECT m.*, o.*, s.display_name as shop_name, s.s as seller_id, t.title as material_name
            FROM ".$siteprefix."order_items m 
            JOIN ".$siteprefix."orders o ON m.order_id = o.order_id 
            JOIN ".$siteprefix."training t ON t.training_id = m.training_id 
            JOIN ".$siteprefix."users s ON t.user = s.s
            WHERE m.order_id = ? 
            GROUP BY s.s";
